        ...
        <div class="mx-auto sm:px-4 lg:px-6">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8 bg-white border-b border-gray-200">
                    ...
                    <h1 class="text-xl mb-4">DynamoDB (Products)</h1>

                    <div class="w-1/4 mb-4">
                        <label class="sr-only" for="name">Filter</label>
                        <form method="get">
                            <input class="w-full p-3 text-sm border-gray-200 rounded-lg" placeholder="Product ID Exp. '2989557'" value="{{ $productId }}" type="text" name="product_id">
                        </form>
                    </div>
                    <div class="flex-col">
                            ...
                            <table class="min-w-full text-sm divide-y divide-gray-200">
                                ...
                                @forelse($products as $key => $product)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{{ $product['product_id'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['product_name'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['product_desc'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['product_url'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['product_price'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['product_image'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['product_category'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['currency'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['seller_name'] }}</td>
                                        <td class="px-4 py-2 text-gray-700 whitespace-nowrap">{{ $product['timestamp'] }}</td>
                                    </tr>
                                @empty
                                    <tr>
